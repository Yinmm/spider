...
def send_request():
    ...
    for i in range(1,8):
        ...
        response = requests.get(url=f'http://www.66ip.cn/areaindex_{i}/1.html', headers=request_header())
        ...
        # tr_list = html.xpath('/html/body/div[4]/div/div/div/div[2]/div/table/tbody/tr')
        tr_list = html.xpath('/html/body/div[4]/div/div/div/div[2]/div/table/tr')
        for td in tr_list:
